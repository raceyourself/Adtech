 ...
 */
public abstract class GIVideoStream extends GIMediaStream {

	protected final static String TAG = "GIVideoStream";
	...
	public GIVideoStream(int camera) {
		super();
		setCamera(camera);
	}
	 ...
	 * You can get the current state of the flash with {@link GIVideoStream#getFlashState()}.
	 */
	...
	protected void encodeWithMediaRecorder() throws IOException, ConfNotSupportedException {
		...
		setInputStream(mReceiver.getInputStream(), (byte)2);
	...
	protected void encodeWithMediaCodecMethod1() throws RuntimeException, IOException {
		...
		setInputStream(new MediaCodecInputStream(mMediaCodec), (byte)2);
